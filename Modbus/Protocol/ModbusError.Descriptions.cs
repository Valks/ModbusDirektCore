...
namespace ModbusDirekt.Modbus.Protocol
{
    ...
    partial class ModbusError
    {
        ...
        internal static readonly string ILLEGAL_FUNCTION = @"ILLEGAL_FUNCTION:
...
is being asked to return register values.";
        ...
        internal static readonly string ILLEGAL_DATA_ADDRESS = @"ILLEGAL_DATA_ADDRESS:
The data address received in the query is not an allowable address for the server. More
...
If a request is submitted with a starting register address of 96 and a quantity of 
registers of 5, then this request will fail with Exception Code 0x02 “Illegal Data Address” 
since it attempts to operate on registers 96, 97, 98, 99 and 100, and there is no register with address 100.";

        internal static readonly string ILLEGAL_DATA_VALUE = @"ILLEGAL_DATA_VALUE:
...
particular register.";
        ...
        internal static readonly string SERVER_DEVICE_FAILURE = @"
An unrecoverable error occurred while the server
was attempting to perform the requested action.";

        internal static readonly string ACKNOWLEDGE = @"
...
completed.";
        ...
        internal static readonly string SERVER_DEVICE_BUSY = @"
Specialized use in conjunction with programming
commands.
...
free.";
        ...
        internal static readonly string MEMORY_PARITY_ERROR = @"
...
can retry the request, but service may be required.";
        ...
        internal static readonly string GATEWAY_PATH_UNAVAILABLE = @"
...
or overloaded.";
        ...
        internal static readonly string GATEWAY_TARGET_DEVICE_FAILED_TO_RESPOND = @"GATEWAY_TARGET_DEVICE_FAILED_TO_RESPOND
Specialized use in conjunction with gateways,
